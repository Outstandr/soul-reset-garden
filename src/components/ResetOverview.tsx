        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3 max-w-6xl mx-auto">
          {resetSteps.map((step, index) => {
            ...
            return (
              ...
              >
                <div className="h-full p-8 rounded-2xl bg-card border border-border shadow-soft hover:shadow-medium transition-all duration-300 relative overflow-hidden">
                  {/* Icon */}
